function nameData() {
  fetch(
    `https://data.nashville.gov/resource/74d7-b74t.json?$$app_token=gLc22Eme02hYsyINkpeT7Z94W&walk_jog_paths=Yes`
  )
    ...
    function addToIten (){
      ...
      let putInItinerary = document.querySelector("#itenirary");
        ...
        let addParkName = document.querySelector("#idSearchResult" + btnIdNumber).textContent;
        
        //puts park name in the itinerary
        
          putInItinerary.innerHTML += `<p>${addParkName}</p>
          `;
